...
if __name__ == "__main__":
    ...
    parser.add_argument('--output_path', type=str, default="./results/ef/")
    ...
    for i in range(len(full_data)):
        ...
        image_path = "/home/yanli/sampled_celebahq_500" + current_image_data['image']
        ...
        if args.mode in ['h_edit_R', 'h_edit_D_p2p', 'h_edit_R_p2p']:
            ...
            edited_w0, _ = negative_prompt_pnp(ldm_stable_each_query, xT=wts[after_skip_steps], etas = 0.0, prompts = prompts, cfg_scales = cfg_scale_list,
                                           controller =controller, prog_bar = True, zs=zs[:(after_skip_steps)])
