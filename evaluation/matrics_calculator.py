...
from local_clip_evaluation import CLIPLoss
...
class MetricsCalculator:
    ...
    def compute_local_clip(self, src_img, src_prompt, tar_img, tar_prompt, mask = None):
        local_clip_loss = CLIPLoss(device=self.device)
        
        return local_clip_loss(src_img, src_prompt, tar_img, tar_prompt).cpu().item()
