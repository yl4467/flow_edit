...
all_tgt_image_folders={
    "guide" : "/home/yanli/h-edit/text-guided/pie_results/h_edit/h_edit_R_total_steps_50_skip_0_implicit_True_eta_1.0_src_orig_1.0_src_edit_5.0_tar_scale_7.5_w_rec_0.1_n_opts_1_time_1756798646_/annotation_images/",
...
if __name__=="__main__":
    ...
    parser.add_argument('--annotation_mapping_file', type=str, default="/home/yanli/PIE-Bench_v1/mapping_file.json")
    ...
    parser.add_argument('--src_image_folder', type=str, default="/home/yanli/PIE-Bench_v1/annotation_images")
    parser.add_argument('--tgt_methods', nargs = '+', type=str, default=[
                                                            "guide",
                                                            ])
    
    parser.add_argument('--result_path', type=str, default="./results/results_pie_hedit.csv")
